...
const sample: EtfView[] = [
  {
    ...
    holdingsCount: 13, recommendedCount: 3, matches: ['NVDA', 'AVGO', 'TXN'],
    action: 'Buy', avgDiscount: 0.2, reason: '3 of 13 holdings recommended',
  },
  {
    symbol: 'XLE', name: 'Energy Select Sector SPDR Fund', currency: 'USD', price: 57.55, aum: '$39.1B',
    holdingsCount: 2, recommendedCount: 0, matches: [],
...
describe('EtfsPage', () => {
  ...
  it('lists ETFs with price, AUM, overlap and action', async () => {
    ...
    expect(smh.getByText('3 / 13')).toBeInTheDocument();
